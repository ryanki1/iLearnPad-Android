...
function twangIt(area, item) {
        ...
        //    audio.play();
        //}
        alert('media: '    + item.attributes.pathSound + $(area).attr('id') + item.attributes.soundType);
