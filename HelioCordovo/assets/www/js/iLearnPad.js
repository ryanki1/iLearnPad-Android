...
function loadAudio(loupe){
	...
	if (!loupe.attributes.audio){
	    	...
	    	for (var i=0; i<loupe.attributes.soundBites.length;i++){
	    		...
	    		media[i] = new Media(loupe.attributes.pathSound + loupe.attributes.soundBites[i] + loupe.attributes.soundType);
	    	}
	    	// KR 20120727 Fix for Android
	    	loupe.attributes.audio = media;	
    	}
